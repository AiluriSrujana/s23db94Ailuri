...
res.render('index', { title: 'searchresults App', user : req.user });
});
router.get('/register', function(req, res) {
res.render('register', { title: 'searchresults App Registration'});
});
...
res.render('login', { title: 'searchresults App Login', user : req.user });
});
